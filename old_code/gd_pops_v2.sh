...
# run_experiment.sh
#
# This bash script runs the python gd_populations_v2.py experiment
...
echo "Running python gd_populations_v2.py with the following parameters:"