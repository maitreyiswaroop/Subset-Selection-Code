# gd_pops_v7.py: Variable Selection with Optional Theta Reparameterization and Advanced T2 Estimator
        ...
        for pop in pop_data:
            ...
            if gradient_mode == 'autograd':
                if t2_estimator_type == 'mc_plugin':
                    term2_value = estimate_T2_mc_flexible(X_std, E_Yx_std, param, parameterization, N_grad_samples, k_kernel)
                elif t2_estimator_type == 'kernel_if_like':
                    Y_std = pop['Y_std']
                    term2_value = estimate_T2_kernel_IF_like_flexible(X_std, Y_std, E_Yx_std, param, parameterization, N_grad_samples, k_kernel)
                else:
