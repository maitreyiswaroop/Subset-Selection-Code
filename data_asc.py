...
Usage:
  ...
  python data_asc.py --year 2018 --plot --save_dir output_data --plot_dir output_plots
...
def get_asc_pop_data(
    ...
    try:
        X_all, Y_all, Xs, Ys, feats, sts = generate_data_asc(
            states=st_list,
            year=year,
            survey=survey,
            horizon=horizon,
...
def main():
    ...
    p.add_argument("--save_dir", default="./data_asc",
    ...
    p.add_argument("--plot_dir", default='./data_asc_plots',
    ...
    try:
        X_all, Y_all, Xs, Ys, feature_cols, states = generate_data_asc(
            states=args.states,
            year=args.year,
            survey=args.survey,
