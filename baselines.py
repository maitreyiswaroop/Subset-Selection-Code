...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset-size', type=int, default=10000, help='Number of samples per population')
    parser.add_argument('--noise-scale', type=float, default=0.01, help='Scale of noise in the data')
    parser.add_argument('--seed', type=int, default=42, help='Random seed')
    parser.add_argument('--save-path', type=str, default='./results/baselines/', help='Path to save results')
