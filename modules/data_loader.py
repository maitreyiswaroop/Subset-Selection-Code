...
class DataManager:
    ...
    def load_or_generate_data(self, pop_configs, m1, m, dataset_size, 
        ...
        if any('baseline' in pop_config['dataset_type'].lower() for pop_config in pop_configs):
            ...
            pop_data, pop_data_test_val = self._generate_asc_data(
                pop_configs, m1, m, dataset_size, asc_data_fraction,
                estimator_type, device, base_model_type, seed
            )
    ...
    def _generate_asc_data(self, pop_configs, m1, m, dataset_size, asc_data_fraction,
                          estimator_type, device, base_model_type, seed):
        # Implement ASC data generation
        from data_asc import get_asc_pop_data
        pop_data = get_asc_pop_data()
        return get_pop_data_asc(
