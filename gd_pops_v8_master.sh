...
t2_types=(mc_plugin kernel_if_like)
seeds=(17 30 29 9 26)
# seed=42
estimator=plugin
population=quadratic_regression
populations=(baseline_failure_1 baseline_failure_2 baseline_failure_3 baseline_failure_6 quadratic_regression interaction_regression piecewise_regression)
N_GRAD_SAMPLES=25
