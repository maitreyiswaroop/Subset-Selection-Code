# grad_desc_populations_v5.py: REINFORCE gradient for Term 2
...
def parse_args():
    ...
    parser.add_argument('--base-model-type', type=str, default='rf', choices=['rf', 'krr'], help='Base model for E[Y|X] estimation (Random Forest or Kernel Ridge)')
